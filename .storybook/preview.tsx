...
const parameters: Preview["parameters"] = {
    ...
    backgrounds: {
        // Hide the "change background" tool in the toolbar. To restore it,
        // remove `disable` and uncomment the options below (plus the
        // matching `backgrounds` entry in initialGlobals).
        disable: true,
        // default: "baseDefault",
        // options: {
        //     baseDefault: {
...
const preview: Preview = {
    ...
    tags: ["autodocs"],
    initialGlobals: {
        // 👇 Set the initial background color (restore together with the
        // backgrounds parameter above)
        // backgrounds: {value: "baseDefault"},
        // Default to the Shape Your Learning (Thunder Blocks) theme
        theme: "thunderblocks",
    },
};
